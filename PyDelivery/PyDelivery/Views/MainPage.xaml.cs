            ...
            if (!MenuPages.ContainsKey(id))
            {
                switch (id)
                {
                    case (int)MenuItemType.Browse:
                        ...
                        break;
                    case (int)MenuItemType.InProgress:
                        MenuPages.Add(id, new NavigationPage(new InProgressPage()));
                        break;
                    case (int)MenuItemType.Delevered:
                        MenuPages.Add(id, new NavigationPage(new DeliveredPage()));
                        break;
                    case (int)MenuItemType.Today:
